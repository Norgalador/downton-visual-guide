...
<body style="background-color: #cbbcb1;">
	...
	<section>
		<div class="bg-image3 vh-100 mask">
			<div class="mask"
			...
			<div class="container">
				<div class="d-flex justify-content-center align-items-center row"
					...
					<button class="btn btn-secondary col-4 opacity-75 mb-3"
						...
						data-bs-target="#roominfo">Learn about the Dining Room</button>

					<div class="collapse card card-body opacity-75 mb-3" id="roominfo">
						<div class="card-body">
							<p>In the evening dinner is served after the once again
								changing of clothes by the Crawley's. Up to eight courses may be
								served, however in small portions. The room is familiar also to
								Mr Carson and the footmen. At dinner Carson leads his way around
								the table with a decanter from which he pours the wine. The
								footmen then take his lead serving portions of food. The family
								take as much from each plate of food as they wish. At a formal
								dinner the way the conversation turns at the table is instructed
								by Lady Grantham who may turn to her left or right and so too
								the the other members at the table.</p>
						</div>
					</div>
				</div>
			</div>
					...
					<div class="card shadow-0 border opacity-100"
						...
						<div class="card-body p-4 ">
							<div class="form-outline mb-4">
								<form:form action="/addcomment/room3" modelAttribute="comments"

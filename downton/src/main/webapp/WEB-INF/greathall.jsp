...
<body style="background-color: #cbbcb1;">
	...
	<section>
		<div class="bg-image2 vh-100 mask">
			<div class="mask"
			...
			<div class="container">
				<div class="d-flex justify-content-center align-items-center row"
					...
					<button class="btn btn-secondary col-4 opacity-75 mb-3"
						...
						data-bs-target="#roominfo">Learn about the Great Hall</button>

					<div class="collapse card card-body opacity-75 mb-3" id="roominfo">
						<div class="card-body">
							<p>The Great Hall is the central atrium of Downton Abbey, and
								reflects the gothic nature of the house with its arched ceiling,
								sweeping columns and intricate styling. At Christmas time, a
								great tree is put up in the Hall, striking awe into the hearts
								of those who see it. Concerts have been held in this Hall, and
								numerous parties, and the Christmas party for the tenant farmers
								in the 2014 Christmas Special. Many dramas have occurred beneath
								its skylights, including Mary and Matthew's kiss, which the
								latter believes led to the death of Lavinia Swire, and Atticus
								Aldridge's proposal to Lady Rose. This room really is the heart
								of the house.</p>
						</div>
					</div>
				</div>
